import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as l,a as n,b as s,d as o,e as a}from"./app-02133217.js";const c="/408CSFamily/assets/线性表的存储结构-45761fc0.png",u="/408CSFamily/assets/顺序表插入平均时间复杂度计算-77743320.png",d="/408CSFamily/assets/顺序表随机删除元素的平均复杂度计算-5b7f2ef1.png",r={},v=a('<h1 id="顺序表示" tabindex="-1"><a class="header-anchor" href="#顺序表示" aria-hidden="true">#</a> 顺序表示</h1><h2 id="定义" tabindex="-1"><a class="header-anchor" href="#定义" aria-hidden="true">#</a> 定义</h2><p><code>顺序表</code>：顺序存储的线性表，<strong>是用一组地址连续的存储单元，依次存储线性表中的数据元素，使得在逻辑上相邻的两个元素在物理位置上也相邻。</strong></p><figure><img src="'+c+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><p>顺序表中的元素的逻辑顺序与实际的物理位置相同</p><p>注意：</p><ul><li>线性表中的元素的位序是从1开始的，例如1、2、3...</li><li>数组中的元素的下标是从0开始的，例如0、1、2...</li></ul><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span> <span class="token directive keyword">define</span> <span class="token macro-name">MaxSize</span> <span class="token expression"><span class="token number">20</span>         </span><span class="token comment">// 定义常量MaxSize 用来声明顺序表的最大长度</span></span>
